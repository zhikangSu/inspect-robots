...
def export(source, output):
    ...
    data = {'schema_version': 1, 'id': 'r5-cube-20260919',
            ...
            'summary': {'physical_success': True, 'grasp_attempts': 1,
                        ...
                        'steps_before_stop': raw[-1]['env_step'],
                        'stop_hold_steps': 1,
                        'executed_steps': log['stats']['total_steps'],
                        'framework_total_steps': log['stats']['total_steps'],
                        'step_count_note': '1553 个普通控制步后，done 仍经过一次保持目标的 step，再结束循环；共 1554 次实际 step。',
